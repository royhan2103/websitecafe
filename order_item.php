...
<div id="struckConten" class="d-none">
  <style>
    #struck {
...
<script>
  function printStruk() {
    var StruckContent = document.getElementById("struckConten").innerHTML;

    var printFrame = document.createElement('iframe');
    printFrame.style.display = 'none';
    document.body.appendChild(printFrame);
    printFrame.contentDocument.write(StruckContent);

...
$query_chart = mysqli_query($conn, "SELECT nama_menu, tb_daftar_menu.id, SUM(tb_list_order.jumlah) AS total_jumlah FROM tb_daftar_menu LEFT JOIN tb_list_order ON tb_daftar_menu.id = tb_list_order.menu
...
<div class="col-lg-9 mt-3">
        ...
        <div class="carousel-inner rounded">
            ...
            foreach ($result as $data) {
                ...
                <div class="carousel-item <?php echo $aktif ?>">
                    <img src="assets/img/daftar_menu/<?php echo $data['foto'] ?>" class="img-fluid"
                        style="height: 250px; width:1000px; object-fit:cover" alt="...">
                    <div class="carousel-caption d-none d-md-block">
                        <h5><b><?php echo $data['nama_menu'] ?></b></h5>
    ...
    <div class="card mt-4 border-0 bg-light">
        <div class="card-body text-center">
            <h5 class="card-title">Cafe - Aplikasi Pemesanan Makanan dan Minuman</h5>
            <p class="card-text">With supporting text below as a natural lead-in to additional content. Lorem ipsum
                dolor sit amet consectetur adipisicing elit. Fugiat ullam similique dicta impedit, provident nostrum
                nemo
                autem corrupti veniam error porro nobis unde obcaecati repudiandae mollitia, aperiam omnis, quis
                officiis.
            </p>

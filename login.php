...
<body class="d-flex align-items-center py-4 bg-body-tertiary">
    ...
    <main class="form-signin w-100 m-auto">
        <form class="needs-validation" novalidate action="proses/proses_login.php" method="POST">
            <img class="mb-4 rounded mx-auto d-block" src="assets/img/login.jpg" alt="" width="100" height="80">
            <h1 class="h3 mb-2 fw-normal text-center">Login</h1>
            ...
            <div class="form-check text-start my-3 text-center">
                <input class="form-check-input position-fixed" type="checkbox" value="remember-me"
                    id="flexCheckDefault">

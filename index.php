...
if (isset($_GET['x']) && $_GET['x'] == 'home') {
  ...
  if ($_SESSION['level_cafe'] == 1 || $_SESSION['level_cafe'] == 2 || $_SESSION['level_cafe'] == 3) {
    $page = "order.php";
    include "main.php";
  } else {
    $page = "home.php";
  ...
  if ($_SESSION['level_cafe'] == 1 || $_SESSION['level_cafe'] == 4) {
    $page = "dapur.php";
    include "main.php";
  } else {
    $page = "home.php";
  ...
  if ($_SESSION['level_cafe'] == 1 || $_SESSION['level_cafe'] == 3) {
    $page = "menu.php";
    include "main.php";
  } else {
    $page = "home.php";

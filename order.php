    ...
    <div class="card-body">
      <div class="row">
        <div class="col d-flex justify-content-end">
          <button class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#TambahUserBaru"> Tambah Order
          </button>
        </div>
      </div>
                ...
                <div class="row">
                  <div class="col-lg-3">
                    <div class="form-floating mb-3">
                      <input readonly type="text" class="form-control" id="kode_order" placeholder="Kode Order"
                        name="kode_order" value="<?php echo date('ymdHi') . rand(100, 999) ?>">
              ...
              <div class="modal-content">
                ...
                <div class="modal-body">
                  <form class="needs-validation" novalidate action="proses/proses_delete_order.php" method="POST">
                    ...
                    <div class="col-lg-12">
                      Apakah anda ingin menghapus order atas nama <b> <?php echo ($row['pelanggan']) ?></b> dengan kode
                      order <b> <?php echo ($row['id_order']) ?> </b>
                    </div>
                    <div class="modal-footer">
                      <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Close</button>

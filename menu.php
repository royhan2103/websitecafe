    ...
    <div class="card-body">
      <div class="row">
        <div class="col d-flex justify-content-end">
          <button class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#TambahUserBaru"> Tambah Menu
          </button>
        </div>
      </div>
                ...
                <tr>
                  ...
                  <td>
                    <div style="width:90px">
                      <img src="assets/img/daftar_menu/<?php echo $row['foto'] ?>" class="img-fluid" alt="...">
                    </div>
                  </td>
